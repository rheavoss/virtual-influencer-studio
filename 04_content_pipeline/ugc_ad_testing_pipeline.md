...
Local Claude Code dashboard → upload Sonia assets → auto-generate 8+ UGC ad variants → review → iterate.
...
Claude Code local dashboard
        ↓
Upload: Sonia image + product/concept brief
        ↓
...
5. **Visual hook:** No text — Sonia in striking pose, no caption for 3 seconds
...
2. **Cance 2 API integration** — POST endpoint with Sonia reference + brief
...
- [ ] 10+ Sonia video clips available as source material
