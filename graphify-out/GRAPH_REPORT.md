...
- `Jasmine Character (AI Influencer)` --defines--> `Jasmine Character Spec (jasmakogirl)`  [INFERRED]
  CLAUDE.md → 99_grok_brain/GROK_BRAIN_SUMMARY.md
- `Grok (Research Gatekeeper)` --gatekeeper_is--> `RALPH v16.1-jasmine (Governance System)`  [INFERRED]
  CLAUDE.md → 99_grok_brain/GROK_VERIFY_RALPH.md
- `Jasmine Project (CLAUDE.md)` --single_source_of_truth_for--> `GROK BRAIN — Jasmine Project State`  [EXTRACTED]
  CLAUDE.md → 99_grok_brain/GROK_BRAIN_SUMMARY.md
- `Antigravity (Research/Copy/Captions)` --coordinates--> `Hybrid Workflow (Grok + Claude + Antigravity)`  [EXTRACTED]
  CLAUDE.md → 90_protocols/HYBRID_WORKFLOW.md
- `Claude Code (Files/Code/Memory)` --coordinates--> `Hybrid Workflow (Grok + Claude + Antigravity)`  [EXTRACTED]
  CLAUDE.md → 90_protocols/HYBRID_WORKFLOW.md
