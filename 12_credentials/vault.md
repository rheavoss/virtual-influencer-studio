...
- **Service:** ProtonMail
- **Email/Username:** `rheavoss.recovery`
- **Password:** `Kriger.5490`
- **Recovery Phrase (Seed):** `hospital purchase enlist keep local example trick exit country decide swap fetch`

## 2. The Main Ecosystem
This is the "Public Facing" email. It is treated like a real human. It is the recovery email for nothing, and its recovery email is the Anchor above.
...
- **Burner 1:** `sigmabean@12` | `soxeweb160@lealking.com` | `Kriger.5490` (SMS Locked)
- **Burner 2:** `[PENDING]`
- **Burner 3:** `[PENDING]`
