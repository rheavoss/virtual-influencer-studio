...
const COST_LABELS = [
  ...
  'IG Ads', 'Taboola', 'Research', 'Buffer', 'Calilio', 'Namecheap', 'SpicyChat', 'Carrd.co', 'Dolphin', 'Team',
];
...
const CONTENT_TYPES = [
  {
    id: 'CT-1', name: 'Viral Reels / Short-form Video Hooks', emoji: '🎬',
    volume: 'Daily', format: 'Instagram Reel · 15–30s · 9:16 · Growth & reach',
    components: [
      { role: 'Source trend',          tool: 'Instaloader (competitor reels)',  cost: 0 },
  ...
  {
    id: 'CT-2', name: 'Instagram Stories (Daily)', emoji: '📱',
    volume: '3–5 per day', format: 'Instagram Stories · 9:16 · Daily engagement',
    components: [
      { role: 'Image gen',             tool: 'Flux Dev + jasmakogirl LoRA',     cost: 0 },
      { role: 'Upscale',               tool: 'SeedVR 2 (2×)',                   cost: 0 },
      { role: 'Story edit / stickers', tool: 'CapCut',                          cost: 0 },
      { role: 'Caption / poll text',   tool: 'jasmine_agent.py',                cost: 0 },
      { role: 'OPSEC',                 tool: 'ExifTool',                        cost: 0 },
      { role: 'Scheduling',            tool: 'Metricool',                       cost: 0 },
    ],
  },
  {
    id: 'CT-3', name: 'Photo Carousels (Storytelling)', emoji: '🖼️',
    volume: '4–5 per week', format: 'Instagram Carousel · 5–10 slides · Deep connection',
    components: [
      { role: 'Multi-image gen',       tool: 'Flux Kontext 9B + jasmakogirl LoRA (ComfyUI)', cost: 25, approx: true },
      { role: 'Upscale all slides',    tool: 'SeedVR 2 (2×)',                   cost: 0 },
  ...
  {
    id: 'CT-4', name: 'Teaser Images / Scroll-stopping Posts', emoji: '📸',
    volume: '3–4 per week', format: 'Instagram Feed · Single image · Quick hooks',
    components: [
      { role: 'Hero image gen',        tool: 'Flux Dev + jasmakogirl LoRA',     cost: 0 },
      { role: 'Upscale',               tool: 'Latent 1.5× → SeedVR 2 (2×)',    cost: 0 },
      { role: 'Outfit variety batch',  tool: 'Flux Kontext variation pass',     cost: 25, approx: true },
      { role: 'Caption text',          tool: 'jasmine_agent.py',                cost: 0 },
      { role: 'OPSEC',                 tool: 'ExifTool',                        cost: 0 },
      { role: 'Scheduling',            tool: 'Metricool',                       cost: 0 },
    ],
  },
  {
    id: 'CT-5', name: 'Emotional / GFE / Savior Syndrome Posts', emoji: '💭',
    volume: '2–3 per week', format: 'Feed Post + Stories · Emotional bonding',
    components: [
      { role: 'Script (emotional arc)', tool: 'Claude / jasmine_agent.py',      cost: 0 },
      { role: 'Voice note (optional)',  tool: 'OmniVoice (emotion-tagged)',      cost: 0 },
      { role: 'Image gen',             tool: 'Flux Dev + jasmakogirl LoRA',     cost: 0 },
      { role: 'Upscale',               tool: 'SeedVR 2 (2×)',                   cost: 0 },
      { role: 'Caption text',          tool: 'jasmine_agent.py',                cost: 0 },
      { role: 'OPSEC',                 tool: 'ExifTool',                        cost: 0 },
  ...
  {
    id: 'CT-6', name: 'Lifestyle & Girl-Next-Door Content', emoji: '✈️',
    volume: '3 per week', format: 'Instagram Reel or Feed Post · Relatable daily life',
    components: [
      ...
      { role: 'Voice narration',       tool: 'OmniVoice',                       cost: 0 },
  ...
  {
    id: 'CT-7', name: 'Behind the Scenes / Authentic Daily', emoji: '🎥',
    volume: '2–3 per week', format: 'Instagram Reel · Casual format · Trust & transparency',
    components: [
      { role: 'Casual scene gen',      tool: 'Flux Dev + jasmakogirl LoRA',     cost: 0 },
      { role: 'Motion (casual I2V)',   tool: 'Wan VACE (natural motion)',       cost: 420 },
      { role: 'Voice (optional)',      tool: 'OmniVoice',                       cost: 0 },
  ...
  {
    id: 'CT-8', name: 'Soft Tease / Lingerie Content', emoji: '🌸',
    volume: '2 per week', format: 'Instagram Feed · Nipple always covered · Paid tease',
    components: [
      { role: 'Lingerie image gen',    tool: 'Flux Dev + jasmakogirl LoRA',     cost: 0 },
      { role: 'Upscale (2-step)',      tool: 'Latent 1.5× → SeedVR 2 (2×)',    cost: 0 },
      { role: 'Compliance check',      tool: 'Manual review (nipple covered)',  cost: 0 },
      { role: 'Caption text',          tool: 'jasmine_agent.py',                cost: 0 },
      { role: 'OPSEC',                 tool: 'ExifTool',                        cost: 0 },
      { role: 'Scheduling',            tool: 'Metricool',                       cost: 0 },
    ],
  ...
  {
    id: 'CT-9', name: 'PPV Teasers', emoji: '🔥',
    volume: '1–2 per week', format: 'Fanvue · Short high-FOMO clip · Drive paid upgrades',
    components: [
      { role: 'Key frame gen',         tool: 'Flux Dev + jasmakogirl LoRA',     cost: 0 },
      { role: 'Tease clip (I2V)',      tool: 'Wan AI Animate 2.2 I2V',         cost: 420 },
      { role: 'Blur / crop effect',    tool: 'CapCut',                          cost: 0 },
      { role: 'FOMO caption',          tool: 'jasmine_agent.py',                cost: 0 },
      { role: 'OPSEC',                 tool: 'ExifTool + FFmpeg',               cost: 0 },
    ],
  },
  {
    id: 'CT-10', name: 'Full PPV / Exclusive Intimate Content', emoji: '💎',
    volume: '1–2 per week', format: 'Fanvue locked · Premium paid-only · High-value revenue',
    components: [
      { role: 'Master image gen',      tool: 'Flux Dev + jasmakogirl LoRA',     cost: 0 },
      { role: 'Upscale (2-step)',      tool: 'Latent 1.5× → SeedVR 2 (2×)',    cost: 0 },
      { role: 'Video (cinema quality)',tool: 'Higgsfield Cinema Studio',        cost: -1 },
      { role: 'Compliance check',      tool: 'Manual review (Option A ceiling)', cost: 0 },
      { role: 'Caption / unlock text', tool: 'jasmine_agent.py',                cost: 0 },
      { role: 'OPSEC',                 tool: 'ExifTool + FFmpeg',               cost: 0 },
    ],
  },
  {
    id: 'CT-11', name: 'UGC Ad / Product Review / Sponsored Content', emoji: '🛍️',
    volume: 'As per brand deals (M4+)', format: 'Instagram Reel · Authentic GND style · Brand deals',
    components: [
      { role: 'Product image',         tool: 'Instagram Shop / Brand brief',    cost: 0 },
...
function deriveRows(data, costMultiplier = 1) {
  return data.map(row => {
    ...
    const cArr  = [row.higgsfield, row.grok, row.claude_code, row.ig_ads, row.taboola, row.research, row.buffer, row.calilio, row.namecheap, row.spicychat, row.carrd, row.dolphin || 0, row.team_salaries || 0].map(v => v * costMultiplier);
...
export default function PLDashboard({ data, costMultiplier = 1 }) {
  ...
  return (
    <div style={S.page}>
      ...
      {/* ── CONTENT PRODUCTION MATRIX ── */}
      <div style={S.card}>
        <div style={S.cardTitle}>🎯 Content Production Matrix — All 11 Types · Components · Tools · Costs</div>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 10 }}>
            <thead>
              <tr style={{ background: '#f6f8fa', borderBottom: `2px solid ${C.grid}` }}>
