> **⚠️ NOT OUR WORKFLOW** — This guide targets Pinokio + Forge + FlexGym (local Mac install). Our workflow is **Vast.ai GPU server**. Use this as reference only — do NOT follow steps literally. Vast.ai training playbook: `00_agency/DATASET_PLAYBOOK.md`.
>
> ---
>
